...
<Image
    src="/drs/guides/avowed/ta.png"
    width="700"
    height="500"
    decoding="async"
    loading="eager"
    alt="Avowed Cheatsheet"
    onclick="window.open('/drs/guides/avowed/ta.png','_blank')"
...
## Guide
### Buster, Raidwide, and Arsenal
3 tank enumeration Buster

Glory of Bozja needs Aethershield

Cut = Sword = Get in **front**.
Dealt = Satff = **Away** from boss when she stops spinning
Mercy = Bow = Get **Behind**. She will *always* re-center herself.
